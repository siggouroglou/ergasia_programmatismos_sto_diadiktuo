...
<t:contentAdmin>
    ...
    <jsp:attribute name="body">
        ...
        <div style="margin: 30px 0; width:98%; text-align: right;">
            <a href="contentAdmin/film_create" class="btn btn-success">
        ...
        <table style="width:780px; margin:20px auto 10px auto;" class="table table-striped">
            ...
            <c:forEach items="${filmList}" var="film">
                <tr>
                    ...
                    <td>
                        <a href="contentAdmin/film_update?film_id=${film.id}" class="btn btn-primary">
        ...
        <script type="text/javascript">
            $(document).on("ready", function () {
                $(".delete-btn").on("click", function () {
                    ...
                    if (deleteIt) {
                        window.location = "contentAdmin/film_delete?film_id=" + id;
                    }
                });
            });
        </script>
