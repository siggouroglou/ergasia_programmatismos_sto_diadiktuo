...
<t:admin>
    ...
    <jsp:attribute name="body">
        <h3 style="padding: 10px;">Επεξεργασία Κωδικού Διαχειριστή Περιεχομένου</h3>

        <form action="admin/contentAdmin_updatePass" method="POST" style="width: 450px; margin: 30px auto;">
            <input type="hidden" name="username" value="${contentAdmin.username}"/>
