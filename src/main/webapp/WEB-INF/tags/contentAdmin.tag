            ...
            <div id="page" class="container" style="display:table;">
                <div style="display:table-cell; width:160px;">
                    <div style="display:block; width:160px; border:1px solid #BBB;">
                        <div class="menu-item">
                            <a href="contentAdmin/home">Αρχική Σελίδα</a>
                        </div>
                        <div class="menu-item">
                            <a href="contentAdmin/film_list">Ταινίες</a>
                        </div>
                        <div class="menu-item">
                            <a href="contentAdmin/provoli_list">Προβολές</a>
                        </div>
                        <div class="menu-item">
                            <a href="contentAdmin/exit">Έξοδος</a>
                        </div>
                    </div>
                </div>
